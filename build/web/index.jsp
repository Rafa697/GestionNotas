          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="Coordinador/insertar.jsp">
              ...
              <div class="card text-white bg-primary o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="coordinador?action=consultar">
          ...
          <div class="row"> 
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              ...
              <div class="card text-white bg-info o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="NotaParcial/insertar.jsp">
              ...
              <div class="card text-white bg-info o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="notaP?action=consultar">
